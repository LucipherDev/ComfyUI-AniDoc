...
from .utils import Extractor, LIGHTGLUE_MODELS_DIR
...
class SuperPoint(Extractor):
    ...
    def __init__(self, **conf):
        ...
        self.load_state_dict(torch.hub.load_state_dict_from_url(url,model_dir=LIGHTGLUE_MODELS_DIR,file_name='superpoint_v1.pth'))
